...
<nav>
	<ul>
		...
		<li><a class="accueil" href="../../src/Controller/controller-accueil.php"><i class="fas fa-home"></i> Accueil</a></li>
		...
		<li><a class="recherche" href="#"><i class="fas fa-search"></i> Recherche</a></li>
		<li>
